...
// (его тоже необходимо создать рядом с html-файлом). В js-файле необходимо создать 
// следующий скрипт:
...
const degreeC = Number.parseInt(prompt ("Введите температуру в градусах Цельсия: "));
const degreeF1 = (9/5)*degreeC + 32;
const degreeF2 = +degreeF1.toFixed(2);
alert(`Цельсий: ${degreeC} , Фаренгейт: ${degreeF2}`);
